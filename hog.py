...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    assert score >= 0, 'The number of points cannot be negative.'
    a = score % 10
    b = score // 10
    return 2 + abs(b - a)
    # END PROBLEM 2
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 3
    if num_rolls == 0:
        points = free_bacon(opponent_score) # "points" is my own variable, pls remember!
        return points
    if num_rolls > 0:
    ...
    if who == 1:
        def gained(score0, score1):
            ...
            if gain > previous_high:
                ...
                return announce_highest(who, previous_high = gain, previous_score = score1)
            else:
                return announce_highest(who, previous_high, previous_score = score1)
        return gained
    else:
        def gained(score0, score1):
            ...
            if gain > previous_high:
                ...
                return announce_highest(who, previous_high = gain, previous_score = score0)
            else:
                return announce_highest(who, previous_high, previous_score = score0)
        return gained
